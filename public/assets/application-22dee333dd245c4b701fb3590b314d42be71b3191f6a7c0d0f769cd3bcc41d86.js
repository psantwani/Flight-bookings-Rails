...
function datePicker(element){	
	...
	"<div class=\"sa-input-error\"></div>"+
	"<input type=\"date\" tabindex=\"1\" placeholder=\"Departure on\" class='inputValue1'>" + 
	"<input type=\"date\" tabindex=\"2\" placeholder=\"Return on\" class='inputValue2'>";
...
function filterPicker(element){
	...
	var datePickerDom = "<input type=\"text\" tabindex=\"3\" placeholder=\"Type here\" style='display:none' value='Demo' />"+
	"<div class=\"sa-input-error\"></div>"+
	"<input type=\"text\" placeholder=\"Price limit &#8377;\" class='inputValue1'>" + 
	"<input type=\"text\" placeholder=\"Preferred airlines\" class='inputValue2'>";
	$(".sweet-alert > fieldset").html(datePickerDom);
}
...
function changeSet1Card(city, element, title){
	var newCard = "<div class = \"trending\">" +
		"<p class = \"city_name\" style='font-family : Raleway'>"+title+"</p>" +
		"<img class = \"city_picture\" src = \"mumbai.jpg\" />" +
		"<p><a style='font-family : Raleway; text-decoration : none' class = \"city_book\" href = \"#\" onclick=\"pickupDrop('Departure','Enter airport/city name',this)\">"+city+"</a></p>" +
		"</div>";
...
function changeSet2Card(params, element){
	var newCard = "<div class = \"trending\">" +
		...
		"<p style=\"margin-top: 50px;\"><a class = \"city_book\" href = '#'' style=\"text-decoration : none;\" onclick=\"datePicker(this)\">Set Dates</a></p>"+
		"</div>";
	element.innerHTML = newCard;	
}
;
